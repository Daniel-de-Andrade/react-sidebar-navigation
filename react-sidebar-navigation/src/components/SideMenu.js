...
const SideMenu = (props) => {
  ...
  */
  // apenas uma pequena melhoria em relação à função de clique do menuItem
  // Agora não há necessidade de usar a variável de estado de expansão no componente MenuItem
